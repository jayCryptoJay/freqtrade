        ...
        {tabs.map(({ id, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={clsx(
                'flex-1 flex flex-col items-center gap-1 py-2.5 px-2 transition-all duration-200 touch-manipulation min-h-[56px] justify-center',
            ...
            >
              ...
              {active && (
                <span className="absolute bottom-[calc(env(safe-area-inset-bottom,0px)+0px)] w-8 h-0.5 bg-sol-purple rounded-full" />
              )}
            </button>
          )
        })}
